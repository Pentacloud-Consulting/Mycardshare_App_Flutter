...
class LeadAuditSearchFilter extends StatefulWidget {
  final String selectedFilter;
  final ValueChanged<String>? onSearchChanged;
  final ValueChanged<String>? onFilterSelected;
  final bool initialFilterVisible;

  const LeadAuditSearchFilter({
    super.key,
  ...
  @override
  State<LeadAuditSearchFilter> createState() => _LeadAuditSearchFilterState();
}

class _LeadAuditSearchFilterState extends State<LeadAuditSearchFilter> {
  final TextEditingController _searchController = TextEditingController();
  late bool _isFilterVisible;

  final List<Map<String, dynamic>> _filters = [
    {'label': 'All', 'color': null},
    {'label': 'Delivered', 'color': const Color(0xFF10B981)},
    {'label': 'Failed', 'color': const Color(0xFFEF4444)},
    {'label': 'Retrying', 'color': const Color(0xFFF59E0B)},
  ];
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        // Search bar + Calendar/Filter Icon Button Row
        Row(
          children: [
            Expanded(
              child: Container(
                ...
                child: TextField(
                  ...
                  decoration: const InputDecoration(
                    hintText: "Search by company, lead...",
